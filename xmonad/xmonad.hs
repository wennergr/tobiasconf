...
defaultLayouts = smartBorders(avoidStruts(
  -- ResizableTall layout has a large master window on the right,
...
chatLayout = avoidStruts(withIM (1%6) (Title myIMRosterTitle) Grid)
...
{-
  Format function to remove an element from the default
  dynamicLogWithPP
-}
empty :: String -> String
empty x = ""
...
main = do
  ...
  , startupHook = do
      setWMName "LG3D"
      windows $ W.view startupWorkspace
